...
image_BGR = cv2.imread('../input/traffic-signs-datasets')
...
[16:39, 12/21/2021] Siddhant: with open('../input/traffic-signs-dataset-in-yolo-format/ts/ts/00001.txt') as f:
...
[16:39, 12/21/2021] Siddhant: %matplotlib inline
